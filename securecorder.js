...
let chunks, fileHandle, recorder, recordStart, size = 0, writableStream
...
function initMimeOptions() {
    const mime_options = document.getElementById('rec_mime_options')
...
function setStatus(state, sizeDelta) {
    ...
    switch (state) {            
        case 0:
            ...
            mime_options.style.display = 'block'
            ...
            try {
                ...
                if (chunks instanceof Array) {
                    ...
                    if (fileHandle) {
                        ...
                        debugger
                        // download.href = URL.createObjectURL(new Blob(await fileHandle.getFile()))
